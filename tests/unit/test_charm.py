...
from charm import TraefikIngressCharm, _STATIC_CONFIG_PATH
...
class TestTraefikIngressCharm(unittest.TestCase):
    ...
    def test_tcp_config(self):
        ...
        data = _requirer_provide_ingress_requirements(
            harness=self.harness, relation=relation,
        ...
        assert charm._stored.tcp_entrypoints == {
            prefix: expected_entrypoint
        }
