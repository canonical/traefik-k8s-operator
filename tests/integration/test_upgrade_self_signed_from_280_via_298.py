...
"""Upgrade traefik with self-signed certificates from revision 280 via 298.
...
5. Verify the same CA still serves the same URL on every unit.
"""
...
from helpers import all_settled, bring_up_self_signed_traefik, verify_https_on_all_units
...
@pytest.mark.setup
def test_upgrade_self_signed_from_280_via_298(
