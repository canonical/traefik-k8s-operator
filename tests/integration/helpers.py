...
async def deploy_tempo_cluster(ops_test: OpsTest):
    ...
    # Switching from stable to edge. We can switch back when this fix makes it to stable:
    # https://github.com/canonical/tempo-operators/pull/161
    tempo_worker_charm_url, worker_channel = "tempo-worker-k8s", "1/edge"
    tempo_coordinator_charm_url, coordinator_channel = "tempo-coordinator-k8s", "1/edge"
